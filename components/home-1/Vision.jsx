      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-2 items-end gap-10 max-md:grid-cols-1 1xl:gap-x-24">
          <div>
            ...
            <h2 className="mb-8 max-lg:mb-4">Our Company&apos;s Vision</h2>
            <p className="mb-11 max-lg:mb-5">
              To be the leading innovator in web and AI solutions, empowering businesses with cutting-edge technology
              that drives growth and transforms industries.
            </p>
            <ul className="mb-14 [&>*:not(:last-child)]:mb-6 max-lg:[&>*:not(:last-child)]:mb-4 ">
              <li className="flex items-center gap-x-2 ">
                ...
                <span className="font-jakarta_sans font-medium dark:text-white">Innovation</span>
              </li>
              <li className="flex items-center gap-x-2">
                <span className=" shadow-icon item-center relative flex h-7 w-7 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium dark:text-white">Excellence</span>
              </li>
              <li className="flex items-center gap-x-2 ">
                <span className=" shadow-icon item-center relative flex h-7 w-7 justify-center rounded-full bg-white dark:bg-dark-200">
                  <FontAwesomeIcon
                ...
                <span className="font-jakarta_sans font-medium dark:text-white">Customer Focus</span>
              </li>
            </ul>
